# date-test-remainder-bot-telegram Project
...
You can then execute your native executable with: `./target/date-test-remainder-bot-telegram-1.0.0-SNAPSHOT-runner`
...
- Camel JOLT ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/jolt.html)): JSON to JSON transformation using JOLT
